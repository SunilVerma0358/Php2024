...
const Sponsar = () => {
  return (
    <div id="Sponsors" className="max-w-[1920px] mx-auto overflow-hidden">
        ...
        <div className="w-full lg:w-4/12 min-h-[350px] text-center">
          <div className="w-full lg:w-1/2 absolute top-[10%] sm:top-[5%] md:left-0 lg:left-[-5%] xl:left-0   2xl:h-[450px]">
            ...
            <div className="absolute top-0 right-0 bottom-0 h-full w-full rounded-[106px] flex justify-center items-center flex-col">
              ...
              <button className=" font-Poppins font-normal text-xl md:text-2xl text-white leading-[36px] bg-black rounded-[78px] py-3 sm:py-[17px] px-8 sm:px-[55px] max-sm:w-full max-w-[360px] mt-8 hover:bg-white hover:text-black  duration-300 common_btn2">
                SPONSOR THE EVENT
              </button>
            </div>
          </div>
